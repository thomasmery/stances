...
class Roots_Vcard_Widget extends WP_Widget {
  ...
  function __construct() {
    $widget_ops = array('classname' => 'widget_roots_vcard', 'description' => __('Use this widget to add a vCard', 'stances'));

    $this->WP_Widget('widget_roots_vcard', __('Roots: vCard', 'stances'), $widget_ops);
  ...
  function widget($args, $instance) {
    ...
    $title = apply_filters('widget_title', empty($instance['title']) ? __('vCard', 'stances') : $instance['title'], $instance, $this->id_base);
  ...
  function form($instance) {
    ...
    ?>
    <p>
      <label for="<?php echo esc_attr($this->get_field_id($name)); ?>"><?php _e("{$label}:", 'stances'); ?></label>
